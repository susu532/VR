      ...
      <div className={styles.container}>
        <div className={styles.heroContent}>
          ...
          <div className={styles.ctaButtons}>
            <Button3D variant="primary" size="large"  onClick={() => window.open('https://experience.emperiavr.com/43a7a3df-694a-4288-bd52-45aaac28b975/public/24fbba32-bb60-49b8-bb41-db4516d456ef/index.html', '_blank')}>
              Enter Experience
            </Button3D>
